...
const ExclamationSvg = () => (
    <svg className="bi bi-exclamation" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor"
         xmlns="http://www.w3.org/2000/svg">
        <path
...
const ArrowUpDownSvg = () => (
    <svg className="bi bi-arrow-down-up" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor"
         xmlns="http://www.w3.org/2000/svg">
...
const ArrowUpDownIcon = props => <Icon component={ArrowUpDownSvg} {...props}/>;


const ManageSvg = () => (
    <svg className="bi bi-gear-wide-connected" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor"
         xmlns="http://www.w3.org/2000/svg">
        <path fillRule="evenodd"
...
const ManageIcon = props => <Icon component={ManageSvg} {...props}/>;
